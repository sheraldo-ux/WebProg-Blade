...
<section id="about" aria-labelledby="about-title" class="-mt-4">
  ...
  <div class="overflow-hidden rounded-lg bg-white shadow mb-8">
    <div class="p-6">
      ...
      <div class="flex justify-center items-center space-x-4 space-y-6">
        @foreach ($team as $member)
          <div
            ...
            <div class="flex w-full h-full rounded-full">
              <img src="{{ $member['image'] }}" alt="{{ $member['name'] }}"
                class="w-full h-90% object-cover rounded-full transition-all duration-400 group-hover:rounded-lg group-hover:-translate-y-14">
            </div>
            <div
              ...
              <h3 class="text-lg text-[#0c52a1] font-semibold pt-2">{{ $member['name'] }}</h3>
              <p class="text-xs font-medium">{{ $member['role'] }}</p>
              <div>
