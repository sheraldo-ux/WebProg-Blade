<section id="support-us" class="max-w-4xl mx-auto px-4 py-12 font-sans">
    ...
    <div class="grid md:grid-cols-2 gap-8">
        ...
        <!-- Share, blom lengkap, ntar bisa get link web nya kalo dah deploy -->
    ...
    <div id="share-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden">
        <div class="bg-white p-8 rounded-lg max-w-md w-full">
            ...
            <div class="flex space-x-4">
                <button onclick="shareApp('twitter')" class="bg-blue-400 text-white px-4 py-2 rounded hover:bg-blue-500 transition-colors">
                    Twitter
                </button>
                <button onclick="shareApp('facebook')" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition-colors">
                    Facebook
                </button>
                <button onclick="shareApp('linkedin')" class="bg-blue-800 text-white px-4 py-2 rounded hover:bg-blue-900 transition-colors">
                    LinkedIn
                </button>
            </div>
